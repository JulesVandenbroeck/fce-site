...
- **N16 The canvas-frame page opens with most of the graph under the panels** (design, D-020 F1).
...
- **N17 `CANVAS_FRAME_DESIGN_WIDTHS` duplicates `SHELL_DESIGN_WIDTHS`** (design/tooling, trivial).
  ...
  _(PR #59 F2)_
- **N18 `_canvas_frame_set_state` labels probes by requested state, not measured** (design/tooling).
